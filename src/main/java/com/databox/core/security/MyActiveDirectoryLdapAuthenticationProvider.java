 ...
 * @since 3.1
 */
public final class MyActiveDirectoryLdapAuthenticationProvider extends AbstractLdapAuthenticationProvider {
     ...
     */
//    public MyActiveDirectoryLdapAuthenticationProvider(String domain) {
//        this (domain, null);
//    }
     ...
     */
    public MyActiveDirectoryLdapAuthenticationProvider(String domain, String url) {
    ...
    protected Collection<? extends GrantedAuthority> loadUserAuthorities(DirContextOperations userData, String username, String password) {
    	...
    	List<Roles> roles = securityDAO.findRoleByUserAccount(username);
...
//        String hexString = Integer.toHexString(code);
        Throwable cause = new Exception(exception.getMessage(), exception);
        switch (code) {
