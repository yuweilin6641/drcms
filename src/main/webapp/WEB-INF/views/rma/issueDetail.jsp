...
$("#repairAjaxBtn").click(function(event) {
    event.preventDefault();
    window.location.href = '/drcms/rma/repairFailParts?id=' + issueId;
});
		...
		<table id="mainTable">
            ...
            <tr>
                <th colspan="2" style="text-align:left;padding: 0px 0px 0px 0px;">
					...
					<input name="" type="button" class="JQbtn" value="輸入備品資料" id="sparePartsAjaxBtn">
					<input name="" type="button" class="JQbtn" value="輸入修復狀態" id="repairAjaxBtn">
                ...
                <td width="50%">
					<fieldset>
						...
						<table id="mainTable">
							...
							<tr><td align="left">Data Center：</td><td><label id="dataCenter"></label></tr>
							...
							<tr><td align="left">Address：</td><td><label id="address"></label></td></tr>
							<tr><td align="left">state：</td><td><label id="state"></label></td></tr>
							<tr><td align="left">Country：</td><td><label id="country"></label></td></tr>
							<tr><td align="left">ZipCode：</td><td><label id="zipCode"></label></td></tr>
						</table>
					</fieldset>
					<fieldset>
